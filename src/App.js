...
import PersonalData from "./Component/Dashboard/Profile/PersonalData";
import Settings from "./Component/Dashboard/Profile/Settings";
import Password from "./Component/Dashboard/Profile/Password";
import LaunchPadList from "./Component/Launchpads/LaunchPadList/LaunchPadList";
import LegionNetwork from "./Component/LandingPage/LegionNetwork/LegionNetwork";
import LegionNetTwo from "./Component/LandingPage/LegionNetTwo/LegionNetTwo";

function App() {
  return (
    <div className="App">
      <Routes>
        <Route path="/" element={<LandingParents />} />
        <Route path="/home" element={<LandingParents />} />
        <Route path="/leaderboard" element={<LeaderBoard />} />
        <Route path="/kycaudit" element={<KycAudit />} />
        <Route path="/documentation" element={<Documentation />} />
        <Route path="/launchpad" element={<LaunchPadsParents />} />
        <Route path="/CreateLanchPad" element={<CreateLanchPad />} />
        <Route path="/launchPadList" element={<LaunchPadList />} />
        <Route path="/Step2" element={<Step2 />} />
        <Route path="/Step3" element={<Step3 />} />
        <Route path="/Step4" element={<Step4 />} />
        <Route path="legionnetwork" element={<LegionNetwork />} />
        <Route path="legionnetTwo" element={<LegionNetTwo />} />
        <Route path="createToken" element={<TokenStepOne />} />
